...
When the bolt takes the offering, every held wand within the circle drinks it and is transmuted
into a **lightning rod** — the vane-on-a-pole that bends every strike within twenty-five meters
harmlessly into the earth (and into any battery seated at its foot).
